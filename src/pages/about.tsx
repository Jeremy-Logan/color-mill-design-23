    ...
    <div>
      ...
      >
        ...
        <h2
          ...
          className="mx-auto mb-12 mt-8 w-10/12 text-left font-serif text-xl font-black text-black sm:w-2/3 sm:text-2xl md:mt-8 md:mb-36 md:text-center lg:w-8/12 lg:text-2xl xl:mt-24 xl:w-8/12 xl:text-3xl 2xl:text-4xl"
        >
        ...
        <p className="mx-auto mt-6 w-[95vw] max-w-[860px] text-lg sm:w-screen">
